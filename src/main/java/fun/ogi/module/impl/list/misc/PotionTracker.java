...
@ModuleInformation(moduleName = "PotionTracker", moduleDesc = "Shows potion success percent", moduleCategory = ModuleCategory.MISC)
public class PotionTracker extends Module {
    ...
    private void sendPotionMessage(String playerName, PotionInfo potionInfo, int percent) {
        ...
        ChatUtil.sendMSG(playerName + " got" + " " + percent + "%");
