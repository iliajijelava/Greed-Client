...
public record BuiltLiquid(
        SizeState size,
        QuadRadiusState radius,
        QuadColorState color
) implements IRenderer {

    private static final ShaderProgramKey LIQUID_SHADER_KEY = new ShaderProgramKey(ResourceProvider.getShaderIdentifier("liquid"),
    ...
    public void render(Matrix4f matrix, float x, float y, float z) {
        ...
        ShaderProgram shader = RenderSystem.setShader(LIQUID_SHADER_KEY);
        ...
        if (shader != null) {
            ...
            if (shader.getUniform("Time") != null) {
                shader.getUniform("Time").set((float) (System.currentTimeMillis() % 1000000) / 1000f);
            }
        }
