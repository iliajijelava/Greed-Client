...
public class ServerUtil  {
    ...
    private String getServer() {
        if (mc.getNetworkHandler() == null || mc.getNetworkHandler().getServerInfo() == null || mc.getNetworkHandler().getBrand() == null) return "Vanilla";
        ...
        else if (brand.contains("holyworld") || brand.contains("holywоrld") || brand.contains("vk.com/idwok")) return "HolyWorld";
