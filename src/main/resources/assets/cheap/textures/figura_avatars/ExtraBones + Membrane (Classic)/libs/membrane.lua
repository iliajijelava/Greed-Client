-- THIS IS A MODIFIED VERSION OF THE MEMBRANE LIBRARY
-- What is modified? I got rid of the line which reparents the membranes
-- Don't update without also getting rid of the line
