...
Where you need to replace LargeLamb with the name of the bbmodel that contains the animations. If you wish to use multiple bbmodels add more as arguments.
...
local anims = require("JimmyAnims")
anims(animations.LargeLamb,animations.EXAMPLE)
