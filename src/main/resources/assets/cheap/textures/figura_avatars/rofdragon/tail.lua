...
function tailPhysics.new(model)
   ...
   obj.config = { -- default config
      velocityStrength = vec(1, 0.2, 1), -- left right, up down, forward backward
      ...
      ---@type number|Vector4
      waterStiff = 1, -- how stiff should tail be underwater
      waterStrength = 0.1, -- how much water will affect tail

      extraMovingStiff = 0.6, -- extra stiff when moving
